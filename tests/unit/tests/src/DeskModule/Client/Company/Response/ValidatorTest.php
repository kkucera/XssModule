...
namespace Unit\src\DeskModule\Client\Company\Response;
...
use DeskModule\Client\Company\Response\Validator;
...
class ValidatorTest extends \PHPUnit_Framework_TestCase
{
    ...
    public function testBindListeners()
    {
        ...
        $eventManager->expects($this->at(0))->method('attachListener')
            ->with($this->isInstanceOf('\DeskModule\Client\Company\Event\Response\Listener\PostCreateExecuteValidator'));

        $eventManager->expects($this->at(1))->method('attachListener')
            ->with($this->isInstanceOf('\DeskModule\Client\Company\Event\Response\Listener\PostReadExecuteValidator'));

        $eventManager->expects($this->at(2))->method('attachListener')
            ->with($this->isInstanceOf('\DeskModule\Client\Company\Event\Response\Listener\PostUpdateExecuteValidator'));
