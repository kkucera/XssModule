...
use DeskModule\Client\Customer\Marshaller\CustomerToCreateCommand;
use DeskModule\Customer\CustomerDto;
use EMRCoreTest\Helper\Reflection;

class CustomerToCreateCommandTest extends \PHPUnit_Framework_TestCase
{

    /** @var CustomerToCreateCommand */
    private $marshaller;

    public function setUp()
    {
        $this->marshaller = new CustomerToCreateCommand;
    }
